import{S as Ss,i as gs,s as Ds,k as s,q as a,a as h,y as ft,l,m as o,r as n,h as t,c as p,z as vt,n as m,b as v,G as e,A as bt,g as ct,d as dt,B as mt,H as $s,N as ps,v as ys,f as Os,K as wt,L as Is,R as Ts,O as Rs}from"../chunks/index.a7566c1a.js";import{A as fs}from"../chunks/Accordion.71344b00.js";import{C as Es}from"../chunks/CodeBlock.a090ee9b.js";import{C as ws}from"../chunks/CodeTabs.6d65d0b1.js";function vs(C,c,d){const b=C.slice();return b[3]=c[d],b}function bs(C,c,d){const b=C.slice();return b[3]=c[d],b}function ks(C){let c,d,b,S,_,E,$,g,T,O,R,z,K,w,Q,X,te,P,Z,se,A,V,y;return{c(){c=s("div"),d=s("strong"),b=a("GET"),S=h(),_=s("div"),E=a("/api/realtime"),$=h(),g=s("p"),T=a("Establishes a new SSE connection and immediately sends a "),O=s("code"),R=a("PB_CONNECT"),z=a(` SSE event with the
